...
if ($_SERVER["REQUEST_METHOD"] == "PUT"){
    ...
    if(!empty($data)){
        ...
        $modelCompt->setCode(cleanData($data->code));
        ...
        $modelCompt->setSolde($soldeActuel);

        if($modelCompt->versementOrRetraitOrVirement()){
            
            return print json_encode(['reponse'=>"versement de ".$nouveauSolde." "." effectuer avec sucess. nouveau solde est: ".$nouveauSolde],http_response_code(200), JSON_PRETTY_PRINT);
        }
    }else{
